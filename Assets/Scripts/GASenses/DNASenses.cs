...
public class DNASenses //helper class that does not inherit from monobehaviour
{
    List<int> genesList;
    int dnaLength = 0;
    int maxValues = 0;

    public DNASenses(int length, int value)
    {
    ...
    public void MixDna(DNASenses dna1, DNASenses dna2)
    {
        for (int i = 0; i < dnaLength; i++)
        {
